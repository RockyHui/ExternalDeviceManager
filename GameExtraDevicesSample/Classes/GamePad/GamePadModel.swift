...
class GamePadModel {
    ...
    // 类型
    var category: GamePadCategory = .Others
    var categoryName: String?
    var displayName: String?
    // 序号
    var index: GamePadIndex = .index1
    // 手柄对象
    ...
    var leftHapticEngine: CHHapticEngine?
    var rightHapticEngine: CHHapticEngine?
    var leftHapticPlayer: CHHapticPatternPlayer?
    var rightHapticPlayer: CHHapticPatternPlayer?
