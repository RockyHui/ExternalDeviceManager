...
typealias MouseButtonInputCallBack = (_ model: MouseDeviceModel, _ button: MouseButton, _ pressed: Bool) -> Void

typealias MouseMoveInputCallBack = (_ model: MouseDeviceModel, _ point: CGPoint) -> Void

typealias MouseScrollInputCallBack = (_ model: MouseDeviceModel, _ point: CGPoint) -> Void
